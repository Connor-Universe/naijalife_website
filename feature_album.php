...
<marquee behavior="" direction="">Follow Us On Our Social Media Handles To Get More Updates From Us</marquee>
      ...
      <div class="container-fluid">
          <div class="row">
             ...
             <input type="text" placeholder="Search featured albums" name="search" class="form-control">
     ...
     <div class="section-two">
       <div class="container-fluid">
         <div class="row">
           <div class="col-lg-12">
           <p class="sub-head"><a href="feature_artist.php" class="latest">Feature Albums</a></p>
              <div class="container-fluid">
                 ...
                 <?php
                             $get_album = "select * from album where type = 'feature' order by rand() DESC LIMIT 0,15" ;
