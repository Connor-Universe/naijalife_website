...
<marquee behavior="" direction="">Follow Us On Our Social Media Handles To Get More Updates From Us</marquee>
      ...
      <div class="container-fluid">
          <div class="row">
             ...
             <input type="text" placeholder="Search All Albums" name="search" class="form-control">
     ...
     <div class="section-two">
       <div class="container-fluid">
         <div class="row">
           <div class="col-lg-12">
           <p class="sub-head"><a href="all_album.php" class="latest">All Albums</a></p>
              <div class="container-fluid">
                 ...
                 <?php
                             $get_album = "select * from album order by rand() DESC LIMIT 0,15" ;
