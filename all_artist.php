...
<marquee behavior="" direction="">Follow Us On Our Social Media Handles To Get More Updates From Us</marquee>
     ...
     <div class="section-two">
       <div class="container-fluid">
         <div class="row">
           <div class="col-lg-12">
           <p class="sub-head"><a href="all_artist.php" class="latest">All Artist</a></p>
              <div class="container-fluid">
                 ...
                 <?php
                             $get_artist = "select * from artist order by rand() DESC LIMIT 0,15" ;
