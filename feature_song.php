...
<marquee behavior="" direction="">Follow Us On Our Social Media Handles To Get More Updates From Us</marquee>
     ...
     <div class="section-two">
       <div class="container-fluid">
         <div class="row">
           <div class="col-lg-9">
           <p class="sub-head"><a href="feature_song.php" class="latest">Featured Songs</a></p>
              <div class="container-fluid">
                 ...
                 <?php
                             $get_song = "select * from song where song_type = 'feature' order by rand() DESC LIMIT 0,15" ;
                    ...
                    <p class='latest'>Latest</p>
                        <p class='comment'><a href='https://naijalifeofficial.com/song.php#disqus_thread'></a><i class='fa fa-comment'></i></a> </p>
           ...
           <div class="col-lg-3">
           <p class="sub-head2"><a href="all_song.php" class="latest">More Artists </a></p>
           <div class="container-fluid">
             <div class="row">
             <?php
